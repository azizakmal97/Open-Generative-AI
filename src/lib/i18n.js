...
const translations = {
    en: {
        ...
        'auth.subtitle': 'Paste a Muapi access key or an OpenRouter key (sk-or-...) to start creating high-aesthetic images.',
        'auth.keyLabel': 'Muapi or OpenRouter Key',
    ...
    zh: {
        ...
        'auth.subtitle': '粘贴 Muapi 访问密钥或 OpenRouter 密钥（sk-or-...）即可开始创建高质量图像。',
        'auth.keyLabel': 'Muapi 或 OpenRouter 密钥',
